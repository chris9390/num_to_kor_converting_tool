...
pattern_wave_kor = re.compile(r'(\d+[.]?\d*\s*\D{0,2}\s*[∼~-]\s*\d+[.]?\d*\s*\D{0,2}\s*(시간|차례|군데|마리|가지|사람|개사|보루|명|시|개|살|달|해|곳|배|대|장|갑|건|종|권|구|봉))')
...
#예) 2018.1.1, 2018.01.01
#예) 2018/1/1, 2018/01/01
pattern_date = re.compile(r'((19|20)\d{2}\s*[-./]\s*(0?[1-9]|1[012])\s*[-./]\s*([12][0-9]|3[0-1]|0?[1-9]))')
...
pattern_kor_with_classifier = re.compile(r'(\d+((,\d{3})*|[.]\d+)\s*((시간|군데|마리|가지|사람|개사|보루)|[명시개살달해곳배대장갑건구척종권구봉]))')
